...
import { crayfishPhoto, mainInfoLogoS, mainInfoLogoM, mainInfoLogoL } from '../../assets';
        ...
        <div className={`${style.mainInfoContainer} d-flex justify-content-center align-items-center position-relative w-100 overflow-hidden`}>
            ...
            <div className="d-flex flex-column justify-content-center align-items-center position-absolute">
                <div className={`${style.infoLogo}`}>
                    <img className="d-flex d-md-none" src={mainInfoLogoS} alt="mainInfoLogoS"/>
                    <img className="d-none d-md-flex d-xl-none" src={mainInfoLogoM} alt="mainInfoLogoM"/>
                    <img className="d-none d-xl-flex" src={mainInfoLogoL} alt="mainInfoLogoL"/>
                </div>
